...
class BaseField(ABC):
    ...
    def object_detection(self, **kwargs):
        raise NotImplementedError

    def semantic_segmentation(self, **kwargs):
        raise NotImplementedError

    def instance_segmentation(self, **kwargs):
        raise NotImplementedError

    def text_recognition(self, **kwargs):
        raise NotImplementedError

    def keypoint_detection(self, **kwargs):
        raise NotImplementedError
